...
let RaspberryPiCameraNative;
try {
 RaspberryPiCameraNative = require('bindings')('raspberry-pi-camera').Native;
} catch (ex) {
  console.warn("Camera hardware unavalable");
  RaspberryPiCameraNative = require('./hwstub.js')
}
